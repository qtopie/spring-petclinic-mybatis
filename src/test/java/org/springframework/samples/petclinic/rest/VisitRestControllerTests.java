...
public class VisitRestControllerTests {
  ...
  @Autowired private VisitRestController visitRestController;
  ...
  public void initVisits() {
    this.mockMvc =
        MockMvcBuilders.standaloneSetup(visitRestController)
  ...
  public void testGetVisitNotFound() throws Exception {
    ...
    this.mockMvc
        .perform(get("/api/visits/-1").accept(MediaType.APPLICATION_JSON))
