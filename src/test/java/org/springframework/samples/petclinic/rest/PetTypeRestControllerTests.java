...
public class PetTypeRestControllerTests {
  ...
  @Autowired private PetTypeRestController petTypeRestController;
  ...
  public void initPetTypes() {
    this.mockMvc =
        MockMvcBuilders.standaloneSetup(petTypeRestController)
  ...
  public void testGetPetTypeNotFound() throws Exception {
    ...
    this.mockMvc
        .perform(get("/api/pettypes/-1").accept(MediaType.APPLICATION_JSON))
